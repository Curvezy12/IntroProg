...
namespace BeersTests {
    public class BeersTests {
        ...
        public void CompareAbvTest(int expected, int index1, int index2) {
            Assert.Equal(this.beersTestList1.BeersList[expected], this.beersTestList1.CompareAbv(this.beersTestList1.BeersList[index1], this.beersTestList1.BeersList[index2]));
        }
